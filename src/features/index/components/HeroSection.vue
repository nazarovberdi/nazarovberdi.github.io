<template>
  <section class="mb-16 animate-fade-up [animation-delay:100ms]">
    <p class="eyebrow mb-4 text-[11px] uppercase tracking-[0.16em]">
    ...
    >
      <span class="block">Nazarov</span>
      <span class="hero-accent block italic text-(--hero-accent)">Berdi</span>
    </h1>
    <div class="grid grid-cols-[minmax(0,1fr)_160px] items-end gap-8 max-sm:grid-cols-1">
      <p class="hero-summary body-muted max-w-[500px] text-[14px] font-light leading-[1.85]">
        Building interfaces and tools in the Vue / Vite ecosystem. Especially interested in
        developer experience, frontend systems, and growing toward future contributions in the Vite
        and Vue world.
      </p>

      <div
        class="self-end border-l border-(--line-strong) pl-5 text-right max-sm:border-l-0 max-sm:border-t max-sm:pl-0 max-sm:pt-4 max-sm:text-left"
      >
